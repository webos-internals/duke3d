...
void CONTROL_GetUserInput( UserInput *info )
{
	...
	if (KB_KeyDown[sc_kpad_8] || KB_KeyDown[sc_UpArrow] || KB_KeyDown[sc_L])
		info->dir = dir_North;
	else if (KB_KeyDown[sc_kpad_2] || KB_KeyDown[sc_DownArrow] || KB_KeyDown[sc_K])
		info->dir = dir_South;
	else if (KB_KeyDown[sc_kpad_4] || KB_KeyDown[sc_LeftArrow] || KB_KeyDown[sc_I])
		info->dir = dir_West;
